...
public class ModelConstants {
    ...
    public static int ACTION_ON_SELECTION_OF_CHARACTER_CARD_ID = 3;
    public static int ACTION_MOVE_STUDENTS_FROM_ENTRANCE_ID = 4;
    ...
    public static int ACTION_FRIAR_ID = 12;
    public static int ACTION_JESTER_ID = 13;
